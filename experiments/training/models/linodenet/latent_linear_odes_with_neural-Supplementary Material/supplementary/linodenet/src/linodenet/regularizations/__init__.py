...
from models.linodenet.regularizations import functional, modular
from models.linodenet.regularizations.functional import (
    banded,
    diagonal,
    identity,
    logdetexp,
...
from models.linodenet.regularizations.modular import (
    Banded,
    Diagonal,
    Identity,
    LogDetExp,
