...
from models.linodenet.projections import functional, modular
from models.linodenet.projections.functional import (
    banded,
    diagonal,
    identity,
    masked,
...
from models.linodenet.projections.modular import (
    Banded,
    Diagonal,
    Identity,
    Masked,
